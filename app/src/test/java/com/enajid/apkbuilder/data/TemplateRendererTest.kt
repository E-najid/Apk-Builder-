...
class TemplateRendererTest {
    ...
    fun `flutter template renders pubspec name and manifest label`() {
        ...
        val assets = mapOf(
            ...
            "$root/android/gradle.properties" to "x\n".toByteArray(),
            "$root/android/gradlew" to "#!/bin/sh\n".toByteArray(),
            "$root/android/gradlew.bat" to "@echo off\n".toByteArray(),
            "$root/android/gradle/wrapper/gradle-wrapper.jar" to byteArrayOf(1, 2),
            "$root/android/gradle/wrapper/gradle-wrapper.properties" to "distributionUrl=x\n".toByteArray(),
